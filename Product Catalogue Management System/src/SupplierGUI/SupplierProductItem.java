 ...
 * @author jared
 */
public class SupplierProductItem extends javax.swing.JFrame {

    ProductItem productItem;
    ProductCategory category;
    Supplier supplier;
    
    public SupplierProductItem(Supplier SP) throws IOException {
        initComponents();
        this.supplier = SP;
    ...
    private void initComponents() {
        ...
        ManageProfileButton1.setText("ADD ITEM");
        ...
        SidePanel.add(RemoveButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 260, 160, -1));
        ...
        SidePanel.add(GenerateButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 290, 120, -1));
        ...
        SidePanel.add(DescriptionInput, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 390, 230, 40));
    ...
    private void ProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProfileButtonActionPerformed
        try {
            ...
            Logger.getLogger(SupplierProductItem.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupplierProductItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new SupplierProductItem(null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(SupplierProductItem.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
