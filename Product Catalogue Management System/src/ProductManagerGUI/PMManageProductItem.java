...
public class PMManageProductItem extends javax.swing.JFrame {
    ...
    public PMManageProductItem(productManager PM) throws IOException {
    ...
    private void initComponents() {
        ...
        getContentPane().add(MainPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 240, 600));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PMManageProductItem(null).setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(PMManageProductItem.class.getName()).log(Level.SEVERE, null, ex);
                }
