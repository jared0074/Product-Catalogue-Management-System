...
public class AdminManageUser extends javax.swing.JFrame {
    ...
    Admin admin;
    /**
     * Creates new form AdminManagePM
     */
    public AdminManageUser(Admin AD) {
        initComponents();
        this.admin = AD;
    }
    ...
    private void initComponents() {
        ...
        ProductManagerButton = new javax.swing.JButton();
        ...
        SupplierButton.setBackground(new java.awt.Color(0, 32, 63));
        SupplierButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        ProductManagerButton.setBackground(new java.awt.Color(0, 32, 63));
        ProductManagerButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ProductManagerButton.setForeground(new java.awt.Color(255, 255, 255));
        ProductManagerButton.setText("PRODUCT MANAGER");
        ProductManagerButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ProductManagerButtonActionPerformed(evt);
            }
        });

        RegisterNewuserButton.setBackground(new java.awt.Color(0, 32, 63));
        RegisterNewuserButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        RegisterNewuserButton.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(ProductManagerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(SupplierButton, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(RegisterNewuserButton, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(200, 200, 200))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(39, 39, 39)
                .addComponent(ProductManagerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addComponent(SupplierButton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(51, 51, 51)
                .addComponent(RegisterNewuserButton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProfileButtonActionPerformed
        try {
            ...
            Logger.getLogger(AdminManageUser.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    ...
    private void SupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SupplierButtonActionPerformed
        try {
            new AdminManageSupplier(admin).setVisible(true);
        } catch (IOException ex) {
            Logger.getLogger(AdminManageUser.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    ...
    private void ProductManagerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProductManagerButtonActionPerformed
        try {
            new AdminManagePM(admin).setVisible(true);
        } catch (IOException ex) {
            Logger.getLogger(AdminManageUser.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
    }//GEN-LAST:event_ProductManagerButtonActionPerformed
    ...
    private void RegisterNewuserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterNewuserButtonActionPerformed
        new RegisterUser(admin).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminManageUser(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton ProductManagerButton;
